...
APP_VERSION = (BASE_DIR / "VERSION").read_text(encoding="utf-8").strip() if (BASE_DIR / "VERSION").exists() else "5.4.0"
...
async def health_ready():
    ...
    try:
        ...
        db_ok = False
    return {"status": "ready" if db_ok else "degraded", "database": db_ok, "version": "5.6.2"}
