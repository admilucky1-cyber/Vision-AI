...
# Heavy deps are lazy-imported so Railway /health can bind before models load.
numpy = None  # filled on first use
SentenceTransformer = None
chromadb = None
embedding_functions = None

def _ensure_vector_deps():
    global numpy, SentenceTransformer, chromadb, embedding_functions
