...
window.onerror = function(msg, url, line, col, error) {
    ...
    console.error(arguments); if (typeof showToast==='function') showToast('Something went wrong — try again.', 'error', 4000);
    return true;
};
...
window.addEventListener('unhandledrejection', function(event) {
    ...
    if (typeof showToast==='function') showToast('Request issue — try again.', 'error', 4000);
});
